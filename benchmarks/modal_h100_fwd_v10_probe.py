"""H100 fwd v10 (dense-W wgmma) vs v1 probe."""
...
app = modal.App("sparsespline-fwd-v10-probe-h100", image=IMAGE)
...
def run_probe() -> str:
    ...
    out["v10_vs_ref"] = report("v10", f_v10, f_ref)
    out["v10_vs_v1"]  = report("v10_vs_v1", f_v10, f_v1)
    out["v10_vs_v1_a_part"]     = report("v10_vs_v1 [a]",  f_v10[:, :H], f_v1[:, :H])
    out["v10_vs_v1_delta_part"] = report("v10_vs_v1 [δ]",  f_v10[:, H:], f_v1[:, H:])
    ...
    t_v10 = med_ms(lambda: spline_kv_fwd_v10_cuda(
        ...
        activation="relu_sq", lambda_scale=lambda_scale))
    out["timing"] = {
        "v1_ms": t_v1, "v10_ms": t_v10,
        "speedup": t_v1 / t_v10 if t_v10 > 0 else 0.0,
    }
